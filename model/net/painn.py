...
class PaiNN(torch.nn.Module):
        ...
        **kwargs,
        ...
        for _ in range(num_layers):
            self.message_layers.append(
                PaiNNMessage(hidden_channels, self.num_rbf + self.femb_channels)
            )
    ...
    def forward(
        ...
        *args, **kwargs
        ...
        femb = self.fourier_basis(diff)
        rbf_emb = self.radial_basis(dist)
        edge_emb = torch.cat([femb, rbf_emb], dim=-1)
