...
from trainer.pl import pl_module
from trainer.pl_cart import pl_module_cart
from dataset.datasets import BaseDataset, AdsSlabDataset
from configs.config import train_config, model_config, data_config, utils_config
...
if train_config['coord'] == 'cartesian':
    model = pl_module_cart(train_config, model_config, utils_config, data_config)
elif train_config['coord'] == 'fractional':
    model = pl_module(train_config, model_config, utils_config, data_config)
